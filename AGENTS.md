...
Before publishing or updating the README, release notes, repository description, or portfolio copy:
...
- Read the rendered GitHub pages after publishing to verify the final copy.

Keep internal implementation and release evidence in the local project journal, not the public README or release description.
